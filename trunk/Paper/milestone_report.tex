...
%%  \centering
%%  \includegraphics[width=\figwidth]{./e_greed.png}
...
%%  \begin{minipage}[b]{.5\linewidth}
%%  \centering
%%  \includegraphics[width=\figwidth]{./exp3.png}
%%  % image.png: 480x480 pixel, 72dpi, 16.93x16.93 cm, bb=0 0 480 480\
%%  \caption{Exp3}
%%  \label{exp3}
%%  \end{minipage}
...
%%  \begin{minipage}[b]{.5\linewidth}
%%  \centering
%%  \includegraphics[width=\figwidth]{./ucb1.png}
%%  % image.png: 480x480 pixel, 72dpi, 16.93x16.93 cm, bb=0 0 480 480\
%%  \caption{UCB1}
%%  \label{ucb1}
%%  \end{minipage}
...
\subfigure[Discretized EXP3]{
\includegraphics[width=\figwidth]{images/exp3.png}
\label{fig:subfig2}
}
\subfigure[Discretized UCB1]{
\includegraphics[width=\figwidth]{images/ucb1.png}
\label{fig:subfig3}
}
\subfigure[HOO]{
\includegraphics[width=\figwidth,angle=270]{images/xarm25k.png}
\label{fig:subfig3}
}
